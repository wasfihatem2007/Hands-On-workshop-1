...
function changeFontSize(amount) {
    ...
    if (currentFontSize === 16) display.innerText = "Normal";
    else if (currentFontSize > 16) display.innerText = "Large";
    else display.innerText = "Small";
}
...
async function resetSession() {
    if(!confirm("Are you sure? This will end the session and email the log to the moderator.")) return;
